        ...
        <div className="flex items-center justify-between flex-wrap gap-4">
          <div className="flex items-center gap-3">
            <Link href="/" className="group">
              <span className="text-2xl font-black tracking-tight heading-display group-hover:opacity-90 transition-opacity">
                Western
              </span>
              <span className="text-xl font-light text-purple-200 ml-1 tracking-wide">
                Averages
              </span>
            </Link>
